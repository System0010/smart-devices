public class SmartWatch extends SmartDevices{
 ...
 public SmartWatch(boolean formCircle, String batteryType, double maxTimeBattery, String modDevice, String displayTipe, String batterytipe, double maxBatteryTime, String colorDv,
...
public String toString() {
  ...
  return "SmartWatch [formCircle=" + formCircle + ", batteryType=" + batteryType + ", maxTimeBattery=" + maxTimeBattery
      + "]" + sDv;
}
